...
<section class="w-full bg-white rounded-[20px] shadow-[0_0_4px_rgba(0,0,0,0.25)] p-8">
    ...
    <div class="grid grid-cols-3 gap-5">
            ...
            <div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-1 text-black">
                        <img class="w-4 h-4" src="https://c.animaapp.com/mf0pte7ijudQ6p/img/mingcute-warning-fill.svg" />
        ...
        <div class="bg-white rounded-[10px] shadow-[0px_0px_4px_#00000040] p-5">
            <div class="flex items-center gap-3 mb-5">
                <img class="w-16 h-16 rounded-full" src="https://c.animaapp.com/mf0pte7ijudQ6p/img/3baa030c96e449f388bdb40dddaf12c6-1.png" />
                <div>
