        ...
        <div class="flex flex-col items-start gap-8 relative self-stretch w-full">
            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center gap-3">
                    <a href="{{ route('director.administration-list') }}" class="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors">
            ...
            <div class="inline-flex flex-col sm:flex-row items-center gap-4 relative w-full justify-center mt-2">
                @if($status === 'pending')
                    <a href="{{ route('director.administration') }}" class="flex w-full sm:w-[200px] h-[45px] items-center justify-center rounded-[10px] border-2 border-[#111111] hover:bg-gray-50 transition-colors">
                ...
                @if($status === 'rejected')
                    <a href="{{ route('director.administration') }}" class="flex w-full sm:w-[200px] h-[45px] items-center justify-center gap-2 bg-[#111111] rounded-[10px] text-white hover:bg-[#333333] transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
