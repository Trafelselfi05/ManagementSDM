...
@section('content')
    ...
    <div
        ...
        <div class="flex flex-col items-start gap-8 relative self-stretch w-full">
            ...
            @if ($status === 'pending')
                <div
                    class="flex flex-col items-center gap-6 relative self-stretch w-full bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-8 border border-amber-200">
                    <!-- Pending Icon -->
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <p class="font-medium text-amber-600 text-sm text-center">Your leave request is waiting for
            ...
            @if ($status === 'approved')
                <div
                    class="flex flex-col items-center gap-6 relative self-stretch w-full bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-200">
                    <!-- Success Icon -->
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <p class="font-medium text-green-600 text-sm text-center">Your leave request has been approved by
                            the administrator</p>
                    </div>
            ...
            @if ($status === 'rejected')
                <div
                    class="flex flex-col items-center gap-6 relative self-stretch w-full bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl p-8 border border-red-200">
                    <!-- Rejection Icon -->
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <p class="font-medium text-red-600 text-sm text-center">Unfortunately, your leave request has been
                            rejected by the administrator</p>
                    </div>
            ...
            @if ($status === 'pending')
                <!-- Pending Information -->
                <div
                    class="flex flex-col gap-3 relative self-stretch w-full bg-blue-50 rounded-xl p-5 border border-blue-200">
            ...
            @if ($status === 'rejected')
                <!-- Rejected Next Steps -->
                <div
                    class="flex flex-col gap-3 relative self-stretch w-full bg-amber-50 rounded-xl p-5 border border-amber-200">
                    <div class="flex items-start gap-3">
                ...
                <div
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-blue-700 text-sm">If you have questions about this rejection or need further
                                clarification, please contact the HR department at <span
                                    class="font-semibold">hr@company.com</span> or call extension <span
                                    class="font-semibold">123</span>.</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div class="inline-flex flex-col sm:flex-row items-center gap-4 relative w-full justify-center mt-2">
                @if ($status === 'pending')
                    <a href="{{ route('director.administration') }}"
                        class="flex w-full sm:w-[200px] h-[45px] items-center justify-center rounded-[10px] border-2 border-[#111111] hover:bg-gray-50 transition-colors">
                        <span class="font-semibold text-[#111111] text-sm">Back to Form</span>
                    </a>
                    <button onclick="cancelRequest()"
                        class="flex w-full sm:w-[200px] h-[45px] items-center justify-center gap-2 bg-red-600 rounded-[10px] text-white hover:bg-red-700 transition-colors">
                ...
                @if ($status === 'approved')
                    ...
                    <button onclick="window.print()"
                        class="flex w-full sm:w-[200px] h-[45px] items-center justify-center gap-2 bg-[#111111] rounded-[10px] text-white hover:bg-[#333333] transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if ($status === 'rejected')
                    ...
                    <a href="mailto:hr@company.com"
                        class="flex w-full sm:w-[200px] h-[45px] items-center justify-center gap-2 rounded-[10px] border-2 border-[#111111] hover:bg-gray-50 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
