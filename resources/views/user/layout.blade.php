        ...
        <header class="bg-white border-b border-gray-200 h-20 flex items-center px-6 lg:px-10">
            <div class="flex items-center justify-between w-full max-w-[1800px] mx-auto">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('profile.show') }}" class="inline-block">
            ...
            <aside class="w-20 min-h-screen bg-white border-r border-gray-200 flex flex-col items-center py-6">
                <nav class="flex flex-col gap-5">
                    ...
                    <div class="group relative">
                        <a href="#" class="w-12 h-12 'bg-primary/10' : 'bg-gray-100 hover:bg-gray-200' rounded-full flex items-center justify-center transition-colors">
                    ...
                    <!-- Projects - Disabled -->
                    <div class="group relative">
                        <div class="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center cursor-not-allowed opacity-50">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
