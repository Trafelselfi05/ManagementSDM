...
<head>
    ...
    <meta charset="utf-8">
    <title>User Profile - Freyaa</title>
            ...
            <div class="flex items-center justify-between w-full max-w-[1800px] mx-auto">
                ...
                <div class="flex items-center gap-3">
                    <div class="text-right hidden sm:block">
                        <h3 class="text-lg font-semibold text-gray-900">Freyaa</h3>
            ...
            <aside class="w-20 min-h-screen bg-white border-r border-gray-200 flex flex-col items-center py-6">
                <nav class="flex flex-col gap-5">
                    ...
                    <div class="group relative">
                        <a href="#" class="w-12 h-12 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition-colors">
                    ...
                    <!-- Profile (Active) -->
                    <div class="group relative">
                        <a href="#" class="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center transition-colors">
                    ...
                    <div class="flex flex-col lg:flex-row gap-12 lg:gap-16">
                        ...
                        <div class="w-full lg:w-96">
                            ...
                            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-12">
                                <div class="w-32 h-32 bg-primary rounded-full flex items-center justify-center text-4xl font-bold text-white shadow-lg">
                                    F
                                </div>
                                ...
                                <div class="text-center sm:text-left">
                                    ...
                                    <button class="bg-primary text-white px-6 py-3 rounded-xl font-semibold text-base hover:bg-primary/90 transition-colors shadow-md">
                                        Change Picture
                                    </button>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="absolute top-0 left-0 h-3 bg-dark rounded-full transition-all duration-500" style="width: 70%;"></div>
                                </div>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex justify-end mb-8">
                                <button class="bg-dark text-white px-6 py-3 rounded-xl font-semibold text-base hover:bg-dark/90 transition-colors shadow-md">
                                    Edit Profile
                                </button>
                            </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="bg-gray-50 border border-gray-200 rounded-xl px-4 py-4 flex items-center justify-between">
                                                <input type="date" 
                                                       value="2006-02-13" 
