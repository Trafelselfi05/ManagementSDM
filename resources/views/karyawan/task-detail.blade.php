...
@section('content')
                    ...
                    @foreach ($tasks as $task)
                        @php
                            ...
                            switch ($status) {
                                ...
                                default: $statusBg = 'bg-red-500'; break;
                            }
                        ...
                        >
                            ...
                            <div class="flex-none w-24 flex justify-center ml-4">
                                <span class="{{ $levelColor }} text-white text-sm font-semibold px-2 py-1 rounded-[10px] level-badge">
                                    {{ $levelLabel }}
                                </span>
                            </div>

                            <div class="flex-none w-28 flex justify-center ml-4">
                                <span class="px-2 py-1 {{ $statusBg }} text-white text-sm font-semibold rounded-[10px] status-badge">
                                    {{ ucfirst($status) }}
                                </span>
                            </div>
    ...
    <!-- Task Detail Modal (same HTML as before) -->
    <div id="taskDetailModal" class="modal-overlay hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <div class="modal-content bg-white rounded-[20px] shadow-lg p-0 overflow-hidden w-[667px]">
            <article class="bg-[url('https://c.animaapp.com/mf0kcxh3ChSQMm/img/rectangle-152.svg')] bg-cover w-full h-[458px] relative" role="main" aria-labelledby="task-title">
                <header class="absolute w-[549px] h-6 top-[21px] left-[66px]">
                    <div class="w-[551px] h-6">
                        <div class="relative w-[549px] h-6">
                            <h1 id="task-title" class="absolute w-[510px] top-0 left-0 font-medium text-[#111111] text-xl tracking-[0] leading-[normal]">Task</h1>
                            <div class="absolute w-[100px] h-5 top-0.5 left-[450px] flex items-center gap-4" role="toolbar" aria-label="Task actions">
                ...
                <hr class="absolute w-[667px] h-px top-[60px] left-0 object-cover border-0 bg-gray-300" aria-hidden="true" />
                <section class="absolute w-[529px] h-[287px] top-[98px] left-[66px]" aria-labelledby="task-details">
                    <h2 id="task-details-heading" class="absolute w-[510px] top-0 left-0 font-semibold text-[#111111] text-[30px] tracking-[0] leading-[normal]">Wordpress plugin update</h2>
                    ...
                    <div class="absolute top-[88px] left-[18px] flex items-center">
                        <div class="inline-flex items-center gap-4">
                            ...
                            <span class="font-medium text-[#7d7d7d] text-base whitespace-nowrap" id="status-label">Status</span>
                        </div>
                        <div id="task-status" class="flex w-[78px] h-6 items-center justify-center gap-2.5 px-[19px] py-1 ml-[190px] bg-[#e94949] rounded-[20px]">
                    ...
                    <div class="absolute top-[133px] left-[18px] flex items-center">
                        <div class="inline-flex items-center gap-4">
                            ...
                            <span class="font-medium text-[#7d7d7d] text-base whitespace-nowrap" id="project-label">Project</span>
                        </div>
                        <div id="task-project" class="absolute w-[333px] h-[19px] top-0 left-[172px] font-semibold text-[#111111] text-base">Website Management Company</div>
                    </div>
                    ...
                    <div class="absolute top-[177px] left-[18px] flex items-center">
                        <div class="flex w-[104px] items-center gap-4">
                            ...
                            <span class="font-medium text-[#7d7d7d] text-base whitespace-nowrap" id="timeline-label">Timeline</span>
                        </div>
                        <time id="task-timeline" class="absolute w-[333px] h-[19px] top-0 left-[172px] font-semibold text-[#111111] text-base" datetime="">
                    ...
                    <div class="absolute top-[221px] left-[18px] flex items-center">
                        <div class="flex w-[104px] items-center gap-4">
                            ...
                            <span class="font-medium text-[#7d7d7d] text-base whitespace-nowrap" id="assignee-label">Assignee</span>
                        </div>
                    ...
                    <div class="absolute top-[265px] left-[18px]">
                        <div class="inline-flex items-center justify-center gap-4">
                            ...
                            <span class="font-medium text-[#7d7d7d] text-base whitespace-nowrap" id="label-section">Label</span>
                        </div>
...
<div id="editTaskModal" class="modal-overlay hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40">
    <div class="modal-content bg-white rounded-[20px] shadow-lg p-0 overflow-hidden w-[667px]">
        <article class="bg-[url('https://c.animaapp.com/mf0kcxh3ChSQMm/img/rectangle-152.svg')] bg-cover w-full relative pt-5 pb-8 px-16"
                 role="main" aria-labelledby="edit-task-title">
            <header class="w-full flex justify-between items-center mb-5">
                <h1 id="edit-task-title" class="font-medium text-[#111111] text-xl tracking-[0] leading-[normal]">
                    Edit Task
                </h1>
                <div role="toolbar" aria-label="Edit task actions">
            ...
            <hr class="w-full h-px object-cover border-0 bg-gray-300 mb-8" aria-hidden="true" />

            <div class="flex flex-col w-full items-start gap-3 mb-1">
                <div class="relative self-stretch font-medium text-[#7d7d7d] text-base tracking-[0] leading-[normal]">
                    Task
                </div>
            </div>

            <div class="flex w-full h-[53px] items-center gap-2.5 px-[21px] py-[17px] bg-[#f4f4f4] rounded-[5px] mb-8">
                <input type="text" id="edit-task-name" class="w-full bg-transparent border-none outline-none font-normal text-[#111111] text-base" placeholder="Task name..." readonly>
            </div>

            <div class="flex items-center gap-[26px] mb-8">
                <div class="relative w-fit font-medium text-[#111111] text-[17px] tracking-[0] leading-[normal]">
                    Task Level
                </div>
                ...
                <div class="inline-flex items-center gap-2 flex-shrink-0">
                    ...
                    <label for="level-low" class="flex items-center gap-2 cursor-pointer">
                        <div class="relative w-[18px] h-[18px] rounded-[9px] border-2 border-solid border-[#ffb32d] level-indicator" data-level="low"></div>
                        <div class="relative w-fit font-medium text-[#111111] text-[17px] tracking-[0] leading-[normal]">Low</div>
                    </label>
                </div>
                ...
                <div class="inline-flex items-center gap-2 flex-shrink-0">
                    ...
                    <label for="level-medium" class="flex items-center gap-2 cursor-pointer">
                        <div class="relative w-[18px] h-[18px] rounded-[9px] border-2 border-solid border-[#ffb32d] level-indicator" data-level="medium"></div>
                        <div class="relative w-fit font-medium text-[#111111] text-[17px] tracking-[0] leading-[normal]">Medium</div>
                    </label>
                </div>
                ...
                <div class="inline-flex items-center gap-2 flex-shrink-0">
                    ...
                    <label for="level-high" class="flex items-center gap-2 cursor-pointer">
                        <div class="relative w-[18px] h-[18px] rounded-[9px] border-2 border-solid border-[#ffb32d] level-indicator" data-level="high"></div>
                        <div class="relative w-fit font-medium text-[#111111] text-[17px] tracking-[0] leading-[normal]">High</div>
                    </label>
                </div>
            </div>
            ...
            <button id="submitEditTask" class="flex w-full h-[65px] items-center justify-center bg-[#111111] rounded-[10px] hover:bg-gray-800 transition-colors">
                <div class="relative w-fit font-normal text-white text-2xl tracking-[0] leading-[normal]">Submit</div>
            </button>
        </article>
    </div>
</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Close detail modal
            if (closeTaskModalBtn) closeTaskModalBtn.addEventListener('click', function () { hideModal(taskDetailModal); });
            ...
            // Close edit modal
            if (closeEditTaskModalBtn) closeEditTaskModalBtn.addEventListener('click', function () { hideModal(editTaskModal); });
            ...
            if (submitEditBtn) {
                submitEditBtn.addEventListener('click', async function (e) {
                    ...
                    try {
                        const res = await fetch("{{ route('karyawan.task.update') }}", {
                            method: 'POST',
                            headers: {
                        ...
                        if (json.success) {
                            ...
                            const row = document.querySelector(`.task-row[data-task-id="${updatedTask.id}"]`);
                            if (row) {
                                // update dataset attributes
                                row.dataset.taskName = updatedTask.name || row.dataset.taskName;
                                row.dataset.level = (updatedTask.level ? (updatedTask.level.charAt(0).toUpperCase() + updatedTask.level.slice(1)) : row.dataset.level);
                                row.dataset.status = (updatedTask.status ? (updatedTask.status.charAt(0).toUpperCase() + updatedTask.status.slice(1)) : row.dataset.status);
                                ...
                                if (levelBadge) {
                                    levelBadge.textContent = (updatedTask.level ? (updatedTask.level.charAt(0).toUpperCase() + updatedTask.level.slice(1)) : '');
                                    // update color classes manually
                                    levelBadge.className = '';
                                    let levelColorClass = '';
                                    if (updatedTask.level === 'high') levelColorClass = 'bg-[#e94949]';
                                    else if (updatedTask.level === 'medium') levelColorClass = 'bg-[#ffb32d]';
                                    else levelColorClass = 'bg-[#6fadc8]';
                                    levelBadge.classList.add(levelColorClass, 'text-white', 'text-sm', 'font-semibold', 'px-2', 'py-1', 'rounded-[10px]', 'level-badge');
                                }

                                // status badge
                                const statusBadge = row.querySelector('.status-badge');
                                if (statusBadge) {
                                    statusBadge.textContent = (updatedTask.status ? (updatedTask.status.charAt(0).toUpperCase() + updatedTask.status.slice(1)) : '');
                                    ...
                                    statusBadge.classList.add('px-2', 'py-1', statusBg, 'text-white', 'text-sm', 'font-semibold', 'rounded-[10px]', 'status-badge');
                                }
                            }
                            ...
                            taskDetailModal.dataset.currentTaskLevel = (updatedTask.level ? (updatedTask.level.charAt(0).toUpperCase() + updatedTask.level.slice(1)) : '');
                            taskDetailModal.dataset.currentTaskStatus = (updatedTask.status ? (updatedTask.status.charAt(0).toUpperCase() + updatedTask.status.slice(1)) : '');
