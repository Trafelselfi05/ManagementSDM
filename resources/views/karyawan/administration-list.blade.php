        ...
        <div class="flex flex-col gap-4" id="leaveRequestsList">
            @foreach ($leaves as $index => $leave)
                ...
                <div class="leave-card bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow cursor-pointer"
                    ...
                    onclick="window.location.href='{{ route('karyawan.administration-status', $leave->id) }}?status={{ strtolower($statusText) }}'">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="{{ route('karyawan.administration-status', $leave->id) }}?status={{ strtolower($statusText) }}"
