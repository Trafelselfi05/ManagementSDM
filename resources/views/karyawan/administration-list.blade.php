...
@section('content')
    ...
    <div class="flex flex-col w-full gap-6">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white rounded-2xl shadow-sm p-6">
            ...
            <a href="{{ route('karyawan.administration') }}" class="flex items-center gap-2 px-5 py-2.5 bg-[#111111] text-white rounded-lg hover:bg-[#333333] transition-colors">
        ...
        <div id="emptyState" class="hidden bg-white rounded-2xl shadow-sm p-12 text-center">
            ...
            <a href="{{ route('karyawan.administration') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#111111] text-white rounded-lg hover:bg-[#333333] transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                </svg>
