...
@section('content')
    ...
    <div class="flex flex-col w-full gap-6">
        <!-- Header Section -->
        <div
            class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white rounded-2xl shadow-sm p-6">
            <div>
            ...
            <a href="{{ route('karyawan.administration') }}"
                class="flex items-center gap-2 px-5 py-2.5 bg-[#111111] text-white rounded-lg hover:bg-[#333333] transition-colors">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            <div class="flex flex-wrap gap-3">
                <button class="filter-tab active px-4 py-2 rounded-lg font-medium text-sm transition-colors"
                    data-status="all">
                    All Requests
                </button>
                ...
                <button class="filter-tab px-4 py-2 rounded-lg font-medium text-sm transition-colors"
        ...
        <div class="flex flex-col gap-4" id="leaveRequestsList">
            ...
            <div class="leave-card bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow cursor-pointer"
                data-status="pending"
                onclick="window.location.href='{{ route('karyawan.administration-status', ['status' => 'pending']) }}'">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div class="flex-1 flex flex-col gap-3">
                        <div class="flex items-center gap-3">
                            <h3 class="font-semibold text-[#111111] text-lg">Cuti Tahunan</h3>
                            <span
                                class="inline-flex items-center gap-1.5 px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-xs font-medium">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('karyawan.administration-status', ['status' => 'pending']) }}"
            ...
            <div class="leave-card bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow cursor-pointer"
                data-status="approved"
                onclick="window.location.href='{{ route('karyawan.administration-status', ['status' => 'approved']) }}'">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div class="flex-1 flex flex-col gap-3">
                        <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('karyawan.administration-status', ['status' => 'approved']) }}"
                            onclick="event.stopPropagation()"
                            class="px-4 py-2 border border-[#111111] text-[#111111] rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
                            View Details
                        </a>
            ...
            <div class="leave-card bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow cursor-pointer"
                data-status="rejected"
                onclick="window.location.href='{{ route('karyawan.administration-status', ['status' => 'rejected']) }}'">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div class="flex-1 flex flex-col gap-3">
                        <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('karyawan.administration-status', ['status' => 'rejected']) }}"
                            onclick="event.stopPropagation()"
                            class="px-4 py-2 border border-[#111111] text-[#111111] rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
                            View Details
                        </a>
        ...
        <div id="emptyState" class="hidden bg-white rounded-2xl shadow-sm p-12 text-center">
            ...
            <a href="{{ route('karyawan.administration') }}"
                class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#111111] text-white rounded-lg hover:bg-[#333333] transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
