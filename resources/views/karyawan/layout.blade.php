                ...
                <nav class="flex flex-col gap-5">
                    ...
                    <div class="group relative">
                        <a href="{{ route('karyawan.administration') }}"
                            class="sidebar-item w-12 h-12 rounded-full {{ request()->routeIs('karyawan.administration') ? 'bg-[#6FAEC9] text-white' : 'text-gray-600' }} flex items-center justify-center transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 31 31">
                                <path
