    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-[10px] shadow-[0px_0px_4px_#00000040] p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Carla Lalisa</h3>
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="text-center">
                    ...
                    <div class="border border-gray-300 rounded-md px-4 py-2">
                        <span class="text-lg font-semibold">210</span>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="w-full bg-gray-300 rounded-full h-6">
                    <div class="bg-blue-900 rounded-full h-6" style="width: 45%">
                        <span class="text-white text-xs float-right mr-2">45%</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[10px] shadow-[0px_0px_4px_#00000040] p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Tony Hank</h3>
                ...
                <div class="flex items-center justify-between">
                    <div class="w-full bg-gray-300 rounded-full h-6 mr-2">
                        <div class="bg-blue-900 rounded-full h-6" style="width: 100%">
                            <span class="text-white text-xs float-right mr-2">100%</span>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-[10px] shadow-[0px_0px_4px_#00000040] p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Eminem</h3>
            ...
            <div>
                ...
                <div class="w-full bg-gray-300 rounded-full h-6">
                    <div class="bg-blue-900 rounded-full h-6" style="width: 70%">
                        <span class="text-white text-xs float-right mr-2">70%</span>
                    </div>
                </div>
            </div>
        </div>
