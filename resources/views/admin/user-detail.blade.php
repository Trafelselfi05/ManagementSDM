                ...
                <div class="flex flex-col  gap-6 w-full">
                    <div class="flex flex-col  gap-4">
                        <img class="w-32 h-32 object-cover rounded-full"
                            src="https://c.animaapp.com/mf3roef4LjlRUB/img/ellipse-59.svg" alt="Profile Picture" />
                        <div class="flex flex-col items-center gap-2 text-center">
                            <input type="text"
                                class="font-bold text-2xl text-[#111111] bg-transparent border-none outline-none  w-full"
                                value="Name Example" id="profile-name">
                            <input type="text"
                                class="font-medium text-lg text-[#7d7d7d] bg-transparent border-none outline-none  w-full"
                                value="UI/UX Designer" id="profile-title">
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <button class="w-40 h-10 bg-[#6fadc8] text-white font-semibold text-base rounded-[10px]"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <input type="email"
                                ...
                                value="lorem@email.com" id="email">
                        </div>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <input type="text"
                                class="h-12 w-full bg-white rounded-[15px] shadow-[0px_0px_4px_#00000026] px-4 py-2 font-medium text-base text-[#111111] border-none outline-none"
                                value="Semarang, Jawa tengah" id="address">
                        </div>
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <input type="date"
                                class="h-12 w-full bg-white rounded-[15px] shadow-[0px_0px_4px_#00000026] px-4 py-2 font-medium text-base text-[#111111] border-none outline-none"
                                value="1999-01-01" id="birth-date">
                        </div>
