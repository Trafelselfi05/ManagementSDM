...
@section('content')
        ...
        <div class="bg-white rounded-[20px] shadow-[0px_0px_4px_#00000040] p-6">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200">
                ...
                <div class="divide-y divide-gray-200 bg-white">
                    <!-- Row 1 -->
                    <div class="flex items-center h-14 px-6 cursor-pointer task-row" data-task-id="1" data-task-name="Wordpress Plugin Update" data-project="Website Management" data-assignee="Athena Cyntia" data-level="High" data-status="To do" data-created="Nov 4" data-timeline="25 November 2024 - 30 November 2024">
                    ...
                    <!-- Row 2 -->
                    <div class="flex items-center h-14 px-6 cursor-pointer task-row" data-task-id="2" data-task-name="Running Login View" data-project="Online Marketplace App" data-assignee="Ashlynn Culhane" data-level="Low" data-status="Progress" data-created="Nov 10" data-timeline="26 November 2024 - 1 December 2024">
                    ...
                    <!-- Row 3 -->
                    <div class="flex items-center h-14 px-6 cursor-pointer task-row" data-task-id="3" data-task-name="Create Website Design" data-project="CafeLink Menu Website" data-assignee="Erika" data-level="Medium" data-status="Complete" data-created="Nov 25" data-timeline="27 November 2024 - 2 December 2024">
                    ...
                    <!-- Row 4 -->
                    <div class="flex items-center h-14 px-6 cursor-pointer task-row" data-task-id="4" data-task-name="Marketplace Display Menu" data-project="SiteCraft Websites" data-assignee="Seon Woo" data-level="High" data-status="Review" data-created="Dec 6" data-timeline="28 November 2024 - 3 December 2024">
                    ...
                    <!-- Row 5 -->
                    <div class="flex items-center h-14 px-6 cursor-pointer task-row" data-task-id="5" data-task-name="Dashboard Revision" data-project="VirtuSphere Digital Innovation" data-assignee="Fathia" data-level="Low" data-status="Complete" data-created="Dec 12" data-timeline="29 November 2024 - 4 December 2024">
                        ...
                        <div class="flex-1 min-w-0 font-semibold text-[#111111] text-base ml-4 truncate">VirtuSphere Digital
                            Innovation</div>
                    ...
                    <!-- Row 6 -->
                    <div class="flex items-center h-14 px-6 cursor-pointer task-row" data-task-id="6" data-task-name="Website Menu View" data-project="CafeLink Menu Website" data-assignee="Erika" data-level="High" data-status="Review" data-created="Dec 18" data-timeline="30 November 2024 - 5 December 2024">
        ...
        <div class="modal-content bg-white rounded-[20px] shadow-lg p-0 overflow-hidden w-[667px]">
            <article class="bg-[url('https://c.animaapp.com/mf0kcxh3ChSQMm/img/rectangle-152.svg')] bg-cover w-full h-[458px] relative" role="main" aria-labelledby="task-title">
                <header class="absolute w-[549px] h-6 top-[21px] left-[66px]">
                    <div class="w-[551px] h-6">
                        <div class="relative w-[549px] h-6">
                            <h1 id="task-title" class="absolute w-[510px] top-0 left-0 font-medium text-[#111111] text-xl tracking-[0] leading-[normal]">
                                Task
                            </h1>
                ...
                <section class="absolute w-[529px] h-[287px] top-[98px] left-[66px]" aria-labelledby="task-details">
                    <h2 id="task-details-heading" class="absolute w-[510px] top-0 left-0 font-semibold text-[#111111] text-[30px] tracking-[0] leading-[normal]">
                    ...
                    <div class="absolute top-[133px] left-[18px] flex items-center">
                        ...
                        <div id="task-project" class="absolute w-[333px] h-[19px] top-0 left-[172px] font-semibold text-[#111111] text-base">
                    ...
                    <div class="absolute top-[177px] left-[18px] flex items-center">
                        ...
                        <time id="task-timeline" class="absolute w-[333px] h-[19px] top-0 left-[172px] font-semibold text-[#111111] text-base" datetime="2024-11-25/2024-11-30">
    ...
    <div id="editTaskModal" class="modal-overlay hidden">
        <div class="modal-content bg-white rounded-[20px] shadow-lg p-0 overflow-hidden w-[667px]">
            <article class="bg-[url('https://c.animaapp.com/mf0kcxh3ChSQMm/img/rectangle-152.svg')] bg-cover w-full h-[458px] relative" role="main" aria-labelledby="edit-task-title">
                <header class="absolute w-[549px] h-6 top-[21px] left-[66px]">
                    <div class="w-[551px] h-6">
                        <div class="relative w-[549px] h-6">
                            <h1 id="edit-task-title" class="absolute w-[510px] top-0 left-0 font-medium text-[#111111] text-xl tracking-[0] leading-[normal]">
                                Edit Task
                            </h1>
                            <div class="absolute w-[53px] h-5 top-0.5 left-[496px]" role="toolbar" aria-label="Edit task actions">
                ...
                <div class="flex flex-col w-[538px] items-start gap-3 absolute top-[107px] left-[65px]">
                    <div class="relative self-stretch mt-[-1.00px] font-medium text-[#7d7d7d] text-base tracking-[0] leading-[normal]">
                        Task
                    </div>
                </div>
                
                <div class="flex w-[538px] h-[53px] items-center gap-2.5 pl-[21px] pr-5 py-[17px] absolute top-[142px] left-[65px] bg-[#f4f4f4] rounded-[5px]">
                ...
                <div class="inline-flex items-center gap-[26px] absolute top-[229px] left-[65px]">
                    <div class="relative w-fit mt-[-1.00px] font-medium text-[#111111] text-[17px] tracking-[0] leading-[normal]">
                        Task Level
                    </div>
                ...
                <button id="submitEditTask" class="flex w-[538px] h-[65px] items-center justify-center gap-2.5 px-[220px] py-3.5 absolute top-[312px] left-[65px] bg-[#111111] rounded-[10px] hover:bg-gray-800 transition-colors">
