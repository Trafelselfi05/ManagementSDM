...
@section('content')
    <section class="w-full bg-white rounded-[20px] shadow-[0_0_4px_rgba(0,0,0,0.25)] p-4 md:p-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 mb-6 md:mb-8">
            <!-- Filter Button -->
            <div
                class="flex items-center justify-center gap-2 bg-white rounded-[10px] shadow-[0px_0px_4px_#00000040] px-4 py-2">
                    ...
                    @forelse ($projects as $index => $project)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-4 text-center text-gray-600">
                                {{ \Carbon\Carbon::parse($project->start_date)->format('M d, Y') }}</td>
                            <td class="py-4 px-4 text-center text-gray-600">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span
                                    class="px-2 py-0.5 bg-[#e94949] text-white text-xs font-semibold rounded-md">{{ $project->level }}</span>
                            </div>
                    ...
                    <div class="space-y-2 mb-3">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span
                                class="text-gray-600">{{ \Carbon\Carbon::parse($project->start_date)->format('M d, Y') }}</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-500">Deadline:</span>
                            <span
                                class="text-gray-600">{{ \Carbon\Carbon::parse($project->deadline)->format('M d, Y') }}</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
    ...
    <div id="statusModal" class="modal-overlay" style="display: none;">
        <div
            class="modal-content bg-white rounded-[20px] shadow-lg p-4 sm:p-6 w-[95%] sm:w-[450px] max-h-[90vh] overflow-y-auto">
            ...
            <form id="statusForm" method="POST" action="{{ route('admin.project.updateStatus') }}">
                @csrf

                <input class="hidden" id="projectId" name="project_id">
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <div class="space-y-2 sm:space-y-3">
                        <!-- Ready -->
                        <label
                            class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors status-option">
