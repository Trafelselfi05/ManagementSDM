...
<script>
    $(document).ready(function() {
        const $buttons = $('#statusFilter .status-btn');
        const $cards = $('#employeeCards .employee-card');
        ...
        function setActiveButton($activeBtn) {
            $buttons.removeClass('bg-gray-900 text-white').addClass('bg-gray-100 text-gray-700');
            $activeBtn.addClass('bg-gray-900 text-white').removeClass('bg-gray-100 text-gray-700');
        }
        ...
        function filterCards(status) {
            ...
            $cards.each(function() {
                const $card = $(this);
                const cardStatus = $card.attr('data-status')?.toLowerCase() ?? '';
            ...
            if (visibleCount === 0) {
                ...
                $emptyTitle.text(statusTitles[status] || 'No tasks');
                $emptyIcon.html(statusIcons[status] || '');
            } else {
        ...
        // Default show "ready"
        const $defaultBtn = $('#statusFilter .status-btn[data-status="ready"]');
